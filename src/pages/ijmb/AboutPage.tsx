    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        >
          ...
          <h1 className="font-serif text-5xl md:text-7xl font-bold leading-tight mb-6">
            ...
            <span className="text-gold-gradient">Academic Future</span>
          </h1>
          <p className="text-muted-foreground text-xl max-w-2xl mx-auto leading-relaxed">
            IJMB.program has been Nigeria's premier advanced level institution for over a decade, transforming secondary school graduates into university-ready scholars.
          </p>
        </motion.div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              We exist to democratise access to quality university education for every Nigerian student, regardless of their background. The IJMB program offers a proven, affordable, and rigorous alternative to the traditional UTME pathway.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
              By combining world-class academic content with modern technology — live classes, AI study tools, and comprehensive digital resources — we prepare students not just for IJMB examinations, but for university success and beyond.
            </p>
            <div className="flex flex-col gap-3">
              {[
                "Accessible education for every Nigerian student",
                "Digital-first learning environment",
                "Rigorous academic standards matched to university demands",
                "Mentorship from experienced educators and alumni",
              ].map((point) => (
          ...
          >
            {[
              ...
              { icon: Users, label: "Community", desc: "5,000+ students across 5 departments" },
            ...
            <div className="flex flex-col gap-8">
              {milestones.map((m, i) => (
                <motion.div
                  ...
                  custom={i * 0.1}
                  variants={fadeUp}
                  className={`flex gap-6 items-start md:items-center ${i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"} pl-14 md:pl-0`}
                >
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-12">
          <h2 className="font-serif text-4xl font-bold mb-4">
            Partner <span className="text-gold-gradient">Universities</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Our graduates have secured admission into these and many more Nigerian universities.
          </p>
        </motion.div>
        <div className="flex flex-wrap justify-center gap-3">
          {partnerUniversities.map((uni, i) => (
            <motion.div
              ...
              className="px-4 py-2.5 rounded-full border border-border bg-surface-1 text-sm text-muted-foreground hover:border-gold/30 hover:text-foreground transition-all"
            >
              {uni}
            </motion.div>
          ))}
          <div className="px-4 py-2.5 rounded-full border border-gold/20 bg-gold/5 text-gold text-sm font-medium">
      ...
      <section className="py-20 px-6 bg-surface-1/30 text-center">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="max-w-2xl mx-auto">
          <h2 className="font-serif text-4xl font-bold mb-4">
            Be Part of the <span className="text-gold-gradient">Story</span>
          </h2>
          <p className="text-muted-foreground text-lg mb-8">
            Applications for the 2025/2026 session are open. Begin your journey today.
          </p>
          <Link
            to="/ijmb/apply"
